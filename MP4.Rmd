...
```
  ...
  We found the average ride duration and average age for each Citi Bike station, and ordered them from longest to shortest rides. The data in this graph reflects the top twenty data points; thus, the Citi Bike stations whose average ride durations were longest, and the corresponding average age of each user.  
